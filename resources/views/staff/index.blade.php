<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('staff.create') }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">
                Add New Staff
            </a>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-4 flex justify-between items-center">
                        <form action="{{ route('staff.index') }}" method="GET" class="flex items-center space-x-4 flex-1">
                            ...
                            @if(request()->hasAny(['search', 'status', 'sort', 'direction']))
                                <a href="{{ route('staff.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded inline-flex items-center">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <thead class="bg-yellow-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        <a href="{{ route('staff.index', array_merge(request()->except(['sort', 'direction']), [
                                            'sort' => 'id',
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('staff.show', $member) }}" class="text-yellow-600 hover:text-yellow-900 mr-3">View</a>
                                        <a href="{{ route('staff.edit', $member) }}" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterTable() {
                ...
                tableRows.forEach(row => {
                    ...
                    const phone = row.querySelector('td:nth-child(5) div:nth-child(1)').textContent.toLowerCase();
                    const address = row.querySelector('td:nth-child(5) div:nth-child(2)').textContent.toLowerCase();
